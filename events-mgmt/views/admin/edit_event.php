...
<body>
    <div class="form-container">
        ...
        <?php endif; ?>
        <form method="post" action="index.php?page=admin_edit_event&id=<?= $event['id'] ?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" id="event_date" name="event_date" required value="<?= date('Y-m-d\TH:i', strtotime($event['event_date'])) ?>" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="capacity" name="capacity" min="0" value="<?= (int)$event['capacity'] ?>" />
            </div>
